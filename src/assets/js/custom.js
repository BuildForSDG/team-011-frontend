    ...
    if (typedjs.length > 0) {
      loadScript(plugin_track + "typed/typed.min.js", function () {
        typedjs.each(function () {
          var $this = $(this),
            //var id = 'typed_' + index;
            $stringsss = $this.attr("data-strings")
              ? $this.data("strings")
              : [],
            $loop =
              $this.data("typed-loop") != "undefined"
                ? $this.data("typed-loop")
                : true,
  ...
  THE.Cookis = function () {
    loadScript(plugin_track + "cookie/herbyCookie.js", function () {
      $(document).herbyCookie({
        ...
        text:
          "We use cookies to ensure you get the best experience on our website, if you continue to browse you'll be in consent with our",
        scroll: false,
        expireDays: 30,
        link: "#",
      });
